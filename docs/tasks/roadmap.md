...
|---------|------|------|-----|-------|--------|-------|--------------|-------|
| MVP (song library, editor, recording, post-recording) | Feature | [croon.md](../croon.md) | [prd-croon-mvp.md](./prd-croon-mvp.md) | [tasks-croon-mvp.md](./tasks-croon-mvp.md) | ✅ Complete | — | 2026-03-13 | All 7 task groups merged to main |
...
| Share Link | ✨ Feature | [spec](../spec/spec-croon-share-link-mvp.md) | [prd-croon-share-link-mvp.md](./prd-croon-share-link-mvp.md) | — | 🔲 Not Started | — | 2026-03-15 | Shareable public URL via Convex (File Storage + DB) + Next.js share page; rich OG previews; 7-day expiry; mini web player with synced lyrics; 3 themes |
