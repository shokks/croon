...
| Share Link | ✨ Feature | [spec](../spec/spec-songbuddy-share-link-mvp.md) | [prd-songbuddy-share-link-mvp.md](./prd-songbuddy-share-link-mvp.md) | — | 🔲 Not Started | — | 2026-03-15 | Shareable public URL via Convex (File Storage + DB) + Next.js share page; rich OG previews; 7-day expiry; mini web player with synced lyrics; 3 themes |
