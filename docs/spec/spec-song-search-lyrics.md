...
## Goal
Implement a 2-step song creation flow in **Croon**:
...
- For the current Croon flow (recording user voice while external music may be playing), sync can drift from external audio.
